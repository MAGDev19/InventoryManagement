...
using InventoryManagement.Utils.Security;
...
{
    opt.SwaggerDoc("V1", new OpenApiInfo { Title = "Inventory Management", Version = "V1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(opt => opt.SwaggerEndpoint("V1/swagger.json", "Inventory Management V1"));
}
